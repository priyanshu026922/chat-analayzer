...
def most_commin_used_word(selected_user,df):
...
def emoji_count(selected_user,df):
   ...
   emoji_df=pd.DataFrame(Counter(emojis).most_common(50))
...
def daily_timeline(selected_user,df):
    ...
    daily_timeline_df=df.groupby('date_num').count()['message'].reset_index()
